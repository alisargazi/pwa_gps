...
<div class="view next-screen">
  ...
  <div class="content">
    ...
    <div class="buttons">
      <material-button id="subscribe" label="Subscribe" raised ${!supported ? 'disabled' : ''}></material-button>
      <material-button id="unsubscribe" label="Unsubscribe" raised ${!supported ? 'disabled' : ''}></material-button>
    </div>
    ...
    <material-textfield 
      ...
      label="Title" 
      id="title"
      value="What PWA Can Do Today"></material-textfield>
    ...
    <material-button id="send" label="Send" raised ${!supported ? 'disabled' : ''}></material-button>
