...
<div id="nfc" class="view next-screen">
  ...
  <div class="content">
    ...
    <div id="nfc-buttons">
      <material-button id="write" label="Write" raised ${!supported ? 'disabled' : ''}>
        <i class="material-icons" slot="left-icon">edit</i>
      </material-button>
      <material-button id="scan" label="Scan" raised ${!supported ? 'disabled' : ''}>
        <i class="material-icons" slot="left-icon">speaker_phone</i>
      </material-button>
      <material-button id="stop-scan" label="Stop scan" raised ${!supported ? 'disabled' : ''}>
