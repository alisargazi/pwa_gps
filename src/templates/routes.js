import {router} from /*'./lib/router.js'*/'blob:https://whatpwacando.today/88053abd-4b42-4f36-820f-94c4835f56bf';
import {handleOffline, handleOnline} from /*'../app.js'*/'blob:https://whatpwacando.today/e39a5462-39c1-4451-a685-9c6333a43eaf';
import /*'@dannymoerkerke/material-webcomponents/src/material-dialog.js'*/'blob:https://whatpwacando.today/808e2371-d193-4fa6-b4fd-72809e05d476';
import {template as sensorSheetTemplate} from /*'./templates/sensor-sheet.js'*/'blob:https://whatpwacando.today/e185640f-0686-473b-aca1-2e50e4b0eb11';
...
const routes = [
  {
    url: '/',
    template: () => importShim('./templates/home.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
      ...
      if(installButton) {
        installButton.addEventListener('click', () => {
          window.deferredPrompt ? window.deferredPrompt.prompt() :
            !supportsInstallPrompt ? installSheet.open() : null;
        });
      }
  ...
  {
    url: '/media',
    template: () => importShim('./templates/media.js', 'https://whatpwacando.today/src/routes.js'),
    onExit() {
  ...
  {
    url: '/audio',
    template: () => importShim('./templates/audio.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/audio-recording',
    template: () => importShim('./templates/audio-recording.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/authentication',
    template: () => importShim('./templates/authentication.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/geolocation',
    template: () => importShim('./templates/geolocation.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  },
  {
    ...
    template: () => importShim('./templates/device-orientation.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/device-motion',
    template: () => importShim('./templates/device-motion.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/web-share',
    template: () => importShim('./templates/web-share.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/share-target',
    template: () => importShim('./templates/share-target.js', 'https://whatpwacando.today/src/routes.js'),
  ...
  {
    url: '/multi-touch',
    template: () => importShim('./templates/multi-touch.js', 'https://whatpwacando.today/src/routes.js')
  },
  {
    url: '/ar-vr',
    template: () => importShim('./templates/ar-vr.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  },
  {
    ...
    template: () => importShim('./templates/speech-synthesis.js', 'https://whatpwacando.today/src/routes.js')
  },
  {
    url: '/speech-recognition',
    template: () => importShim('./templates/speech-recognition.js', 'https://whatpwacando.today/src/routes.js'),
    onExit() {
  ...
  {
    url: '/page-lifecycle',
    template: () => importShim('./templates/page-lifecycle.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
      const getState = () => {
  ...
  {
    url: '/notifications',
    template: () => importShim('./templates/notifications.js', 'https://whatpwacando.today/src/routes.js'),
    async controller() {
  ...
  {
    url: '/bluetooth',
    template: () => importShim('./templates/bluetooth.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/contacts',
    template: () => importShim('./templates/contacts.js', 'https://whatpwacando.today/src/routes.js'),
    async controller() {
  ...
  {
    url: '/network-info',
    template: () => importShim('./templates/network-info.js', 'https://whatpwacando.today/src/routes.js')
  },
  {
    url: '/info',
    template: () => importShim('./templates/info.js', 'https://whatpwacando.today/src/routes.js'),
    async controller() {
      await Promise.all([
  ...
  {
    url: '/payment',
    template: () => importShim('./templates/payment.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/wake-lock',
    template: () => importShim('./templates/wake-lock.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/vibration',
    template: () => importShim('./templates/vibration.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/nfc',
    template: () => importShim('./templates/nfc.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/file-system',
    template: () => importShim('./templates/file-system.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
      ...
      saveAsButton.addEventListener('click', () => fileTree.saveFileAs(fileContent.querySelector('textarea').value));
  ...
  {
    url: '/barcode',
    template: () => importShim('./templates/barcode.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
  ...
  {
    url: '/face-detection',
    template: () => importShim('./templates/face-detection.js', 'https://whatpwacando.today/src/routes.js'),
    controller() {
...
//# sourceURL=https://whatpwacando.today/src/routes.js